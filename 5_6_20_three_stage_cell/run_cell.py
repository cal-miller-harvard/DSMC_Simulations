...
flows = [4] # sccm
gaps = [4E-3]#[2E-3, 4E-3, 6E-3, 8E-3, 10E-3] # m
lengths = [20E-3]##[10E-3, 20E-3, 30E-3] # m
for flow in flows:
    for gap in gaps:
...
boundary	        o ao p
create_box  	    0 0.35 0 0.03 -0.1 0.1
create_grid 	    20 20 1 
...
read_surf           data.secondstage atrans $(2*(v_GAP - 2.7E-3) + v_LEN + 2.07E-3) 0 0 group secondstage

read_surf           data.mesh atrans $(2*(v_GAP - 2.7E-3) + v_LEN + 2.07E-3) 0 0 group mesh
read_surf           data.mesh atrans $(2*(v_GAP - 2.7E-3) + v_LEN + 2.07E-3) 1.21E-3 0 group mesh
read_surf           data.mesh atrans $(2*(v_GAP - 2.7E-3) + v_LEN + 2.07E-3) 2.42E-3 0 group mesh
read_surf           data.mesh atrans $(2*(v_GAP - 2.7E-3) + v_LEN + 2.07E-3) 3.63E-3 0 group mesh

region tsbody cylinder x 0 0 1 $(2*v_GAP + 65.09E-3 + 1E-3 + v_LEN + 2.07E-3) 1
group tsbody surf region tsbody all
move_surf tsbody trans $(v_LEN-11.11E-3) 0 0 connect yes
